...
{
    public class CatalogItemAggregateRepository : ICatalogItemAggregateRepository
    {
        private readonly ApplicationDbContext _context;
        public CatalogItemAggregateRepository(ApplicationDbContext applicationDbContext)
        {
